...
#   1. Init a fresh project (memory.db + 6 baseline skills materialized).
#   2. Create a module.
...
[ "$SKILL_COUNT" = "6" ] || { echo "✗ expected 6 baseline skills, got $SKILL_COUNT"; exit 1; }
echo "  ✓ memory.db + 6 baseline skills materialized"
